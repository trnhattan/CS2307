...
FROM (VALUES
    ...
    ('LLM_PROVIDER', 'LLM provider selected by the administrator: openrouter or gemini.'),
    ('LLM_MODEL', 'Configured LLM model. A gemini- model uses Gemini; other model names use OpenRouter.'),
    ('LLM_REASONING_ENABLED', 'Request provider-supported reasoning for LLM operations.'),
